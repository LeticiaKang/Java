...
public class WebtoonExample {
	...
	public static void main(String[] args) {
		...
		Webtoon w1 = new Webtoon("i-12345", "웹툰1", "코믹", "저자1");
		Webtoon w2 = new Webtoon("i-12346", "웹툰2", "스릴러", "저자2");
		Webtoon w3 = new Webtoon("i-12347", "웹툰3", "드라마", "저자3");
		
		ab.add(w1);
		ab.add(w2);
		ab.add(w3);
		ab.add(new Webtoon("i-123499", "웹툰4", "드라마", "저자4"));
